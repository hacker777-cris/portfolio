...
import { Github, ExternalLink, Home, Building, BookOpen, Share2, ShoppingCart, Users, Wallet, Mail, Phone, Globe } from 'lucide-react';
...
const projects: Project[] = [
  {
    title: "RAXAN Homes",
    description: "A modern property rental/sale platform built with React Native & Expo, featuring real-time listings and interactive virtual tours. Includes advanced filtering, 3D property viewing, and instant messaging.",
    techStack: ["React Native", "Expo", "Node.js", "MongoDB", "WebRTC", "Firebase"],
  ...
  },
  {
    ...
    description: "Comprehensive rental management system with dynamic subscription calculations and automated billing. Features tenant portals, maintenance requests, and financial reporting.",
  ...
  },
  {
    ...
    description: "Professional Q&A platform connecting students with expert writers, featuring real-time collaboration, plagiarism checking, and automated citation generation.",
  ...
  },
  {
    ...
    description: "A Django + React tool for managing multiple social media accounts with analytics, content scheduling, and automated posting across platforms.",
  ...
  },
  {
    ...
    description: "A Django-based e-commerce platform with advanced inventory management, real-time order tracking, and integrated payment processing.",
  ...
  {
    title: "ConnectHub",
    description: "A social networking app built with Django for seamless virtual interaction, featuring real-time messaging, event planning, and community forums.",
  ...
  {
    title: "Dowell Wallet",
    description: "A fintech solution handling transactions, withdrawals, and multi-currency support with robust security measures and real-time exchange rates.",
  ...
  },
  {
    ...
    description: "An automated system for email & SMS marketing campaigns with A/B testing, analytics, and customer segmentation capabilities.",
  ...
  },
  {
    ...
    description: "A Django-based API for Paybill payments, webhook notifications & WhatsApp receipts, featuring automated reconciliation and reporting.",
  ...
  },
  {
    ...
    description: "A tool for accessing geo-restricted content seamlessly, with advanced caching, load balancing, and proxy management.",
